...
import de.ritterbach.jameica.energie.gui.menu.GasZaehlerMenu;
...
public class GasZaehlerList extends AbstractView {
	...
	public void bind() throws Exception {
		GUI.getView().setTitle(Settings.i18n().tr("ZaehlerGas list"));

		DBService service = Settings.getDBService();
		this.tableZaehler = new TablePart(service.createList(ZaehlerGas.class), null);
		...
		this.tableZaehler.setContextMenu(new GasZaehlerMenu());
		...
		this.tableZaehler.addChangeListener(new TableChangeListener() {
			public void itemChanged(Object object, String attribute, String newValue) throws ApplicationException {
				try {
					ZaehlerGas z = (ZaehlerGas) object;

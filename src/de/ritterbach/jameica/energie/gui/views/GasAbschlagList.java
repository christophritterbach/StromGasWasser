...
import de.ritterbach.jameica.energie.gui.menu.GasAbschlagMenu;
...
public class GasAbschlagList extends AbstractView {
	...
	public void bind() throws Exception {
		GUI.getView().setTitle(Settings.i18n().tr("AbschlagGas list"));

		DBService service = Settings.getDBService();
		this.tableAbschlag = new TablePart(service.createList(AbschlagGas.class), null);
		...
		this.tableAbschlag.setContextMenu(new GasAbschlagMenu());
		...
		this.tableAbschlag.addChangeListener(new TableChangeListener() {
			public void itemChanged(Object object, String attribute, String newValue) throws ApplicationException {
				try {
					AbschlagGas z = (AbschlagGas) object;

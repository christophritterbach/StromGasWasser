...
import de.ritterbach.jameica.energie.gui.control.GasAbschlagReiheControl;
...
public class GasAbschlagReiheDetail extends AbstractView {

	@Override
	public void bind() throws Exception {
		GUI.getView().setTitle(Settings.i18n().tr("AbschlagGas list details"));
		final GasAbschlagReiheControl control = new GasAbschlagReiheControl(this);

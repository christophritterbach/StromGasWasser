...
import de.ritterbach.jameica.energie.gui.control.WasserAbschlagReiheControl;
...
public class WasserAbschlagReiheDetail extends AbstractView {

	@Override
	public void bind() throws Exception {
		GUI.getView().setTitle(Settings.i18n().tr("AbschlagWasser list details"));
		final WasserAbschlagReiheControl control = new WasserAbschlagReiheControl(this);

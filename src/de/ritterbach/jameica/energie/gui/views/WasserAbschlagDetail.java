...
import de.ritterbach.jameica.energie.gui.control.WasserAbschlagControl;
...
public class WasserAbschlagDetail extends AbstractView {

	public WasserAbschlagDetail() {
	}

	@Override
	public void bind() throws Exception {
		// draw the title
		GUI.getView().setTitle(Settings.i18n().tr("AbschlagWasser details"));
		final WasserAbschlagControl control = new WasserAbschlagControl(this);
		...
		buttons.addButton(Settings.i18n().tr("Delete"), new WasserAbschlagDelete(), control.getCurrentObject());

...
import de.ritterbach.jameica.energie.gui.control.StromZaehlerReiheControl;
...
public class StromZaehlerReiheDetail extends AbstractView {

	@Override
	public void bind() throws Exception {
		GUI.getView().setTitle(Settings.i18n().tr("ZaehlerStrom list details"));
		final StromZaehlerReiheControl control = new StromZaehlerReiheControl(this);

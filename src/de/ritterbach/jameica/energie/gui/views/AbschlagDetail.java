...
import de.ritterbach.jameica.energie.gui.control.AbschlagControl;
...
public class AbschlagDetail extends AbstractView {

	public AbschlagDetail() {
	}

	@Override
	public void bind() throws Exception {
		// draw the title
		GUI.getView().setTitle(Settings.i18n().tr("Abschlag details"));
		// instanciate controller
		final AbschlagControl control = new AbschlagControl(this);

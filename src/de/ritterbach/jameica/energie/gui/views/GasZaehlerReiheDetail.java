...
import de.ritterbach.jameica.energie.gui.control.GasZaehlerReiheControl;
...
public class GasZaehlerReiheDetail extends AbstractView {

	@Override
	public void bind() throws Exception {
		GUI.getView().setTitle(Settings.i18n().tr("ZaehlerGas list details"));
		final GasZaehlerReiheControl control = new GasZaehlerReiheControl(this);

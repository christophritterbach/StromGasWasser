...
import de.ritterbach.jameica.energie.gui.menu.WasserAbschlagMenu;
...
public class WasserAbschlagList extends AbstractView {
	...
	public void bind() throws Exception {
		GUI.getView().setTitle(Settings.i18n().tr("AbschlagWasser list"));

		DBService service = Settings.getDBService();
		this.tableAbschlag = new TablePart(service.createList(AbschlagWasser.class), null);
		...
		this.tableAbschlag.setContextMenu(new WasserAbschlagMenu());
		...
		this.tableAbschlag.addChangeListener(new TableChangeListener() {
			public void itemChanged(Object object, String attribute, String newValue) throws ApplicationException {
				try {
					AbschlagWasser z = (AbschlagWasser) object;

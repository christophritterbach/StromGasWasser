...
import de.ritterbach.jameica.energie.gui.control.GasAbschlagControl;
...
public class GasAbschlagDetail extends AbstractView {

	public GasAbschlagDetail() {
	}

	@Override
	public void bind() throws Exception {
		// draw the title
		GUI.getView().setTitle(Settings.i18n().tr("AbschlagGas details"));
		final GasAbschlagControl control = new GasAbschlagControl(this);
		...
		buttons.addButton(Settings.i18n().tr("Delete"), new GasAbschlagDelete(), control.getCurrentObject());

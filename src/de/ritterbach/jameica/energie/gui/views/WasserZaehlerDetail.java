...
import de.ritterbach.jameica.energie.gui.control.WasserZaehlerControl;
...
public class WasserZaehlerDetail extends AbstractView {

	public WasserZaehlerDetail() {
	...
	public void bind() throws Exception {
		// draw the title
		GUI.getView().setTitle(Settings.i18n().tr("ZaehlerWasser details"));
		final WasserZaehlerControl control = new WasserZaehlerControl(this);
		...
		buttons.addButton(Settings.i18n().tr("Delete"), new WasserZaehlerDelete(), control.getCurrentObject());

...
import de.ritterbach.jameica.energie.gui.menu.WasserZaehlerMenu;
...
public class WasserZaehlerList extends AbstractView {
	...
	public void bind() throws Exception {
		GUI.getView().setTitle(Settings.i18n().tr("ZaehlerWasser list"));

		DBService service = Settings.getDBService();
		this.tableZaehler = new TablePart(service.createList(ZaehlerWasser.class), null);
		...
		this.tableZaehler.setContextMenu(new WasserZaehlerMenu());
		...
		this.tableZaehler.addChangeListener(new TableChangeListener() {
			public void itemChanged(Object object, String attribute, String newValue) throws ApplicationException {
				try {
					ZaehlerWasser z = (ZaehlerWasser) object;

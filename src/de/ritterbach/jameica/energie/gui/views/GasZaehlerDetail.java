...
import de.ritterbach.jameica.energie.gui.control.GasZaehlerControl;
...
public class GasZaehlerDetail extends AbstractView {

	public GasZaehlerDetail() {
	...
	public void bind() throws Exception {
		// draw the title
		GUI.getView().setTitle(Settings.i18n().tr("ZaehlerGas details"));
		final GasZaehlerControl control = new GasZaehlerControl(this);
		...
		buttons.addButton(Settings.i18n().tr("Delete"), new GasZaehlerDelete(), control.getCurrentObject());

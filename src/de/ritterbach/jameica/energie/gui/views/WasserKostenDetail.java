...
import de.ritterbach.jameica.energie.gui.control.WasserKostenControl;
...
public class WasserKostenDetail extends AbstractView {

	public WasserKostenDetail() {
	}

	@Override
	public void bind() throws Exception {
		// draw the title
		GUI.getView().setTitle(Settings.i18n().tr("KostenWasser details"));
		// instanciate controller
		final WasserKostenControl control = new WasserKostenControl(this);
		...
		buttons.addButton(Settings.i18n().tr("Delete"), new WasserKostenDelete(), control.getCurrentObject());

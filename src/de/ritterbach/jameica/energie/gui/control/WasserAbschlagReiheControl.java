...
public class WasserAbschlagReiheControl extends AbstractControl {

	private DateInput abschlagDatumAnfang;
	private DateInput abschlagDatumEnde;
	private DecimalInput abschlagBetrag;

	public WasserAbschlagReiheControl(AbstractView view) {
		super(view);
	}
	...
	public void handleStore() {
		try {
			...
			while (datum.before(endeDatum)) {
				AbschlagWasser aw = (AbschlagWasser) Settings.getDBService().createObject(AbschlagWasser.class, null);

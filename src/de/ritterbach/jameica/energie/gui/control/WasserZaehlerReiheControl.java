...
public class WasserZaehlerReiheControl extends AbstractControl {

	private DateInput zaehlerDatumAnfang;
	private DateInput zaehlerDatumEnde;
	private DecimalInput zaehlerVerbrauch;

	public WasserZaehlerReiheControl(AbstractView view) {
		super(view);
	}
	...
	public void handleStore() {
		try {
			...
			while (datum.before(endeDatum)) {
				ZaehlerWasser zw = (ZaehlerWasser) Settings.getDBService().createObject(ZaehlerWasser.class, null);

...
public class GasAbschlagReiheControl extends AbstractControl {

	private DateInput abschlagDatumAnfang;
	private DateInput abschlagDatumEnde;
	private DecimalInput abschlagBetrag;

	public GasAbschlagReiheControl(AbstractView view) {
		super(view);
	}
	...
	public void handleStore() {
		try {
			...
			while (datum.before(endeDatum)) {
				AbschlagGas aw = (AbschlagGas) Settings.getDBService().createObject(AbschlagGas.class, null);

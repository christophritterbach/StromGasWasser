...
public class StromZaehlerRecalculate implements Action {

	@Override
	public void handleAction(Object context) throws ApplicationException {
		try {
			EnergieDBService service = Settings.getDBService();
			DBIterator list = service.createList(ZaehlerStrom.class);
			...
			while (list.hasNext()) {
				ZaehlerStrom zaehler = (ZaehlerStrom) list.next();

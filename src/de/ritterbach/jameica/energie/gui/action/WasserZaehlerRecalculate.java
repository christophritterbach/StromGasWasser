...
public class WasserZaehlerRecalculate implements Action {

	@Override
	public void handleAction(Object context) throws ApplicationException {
		try {
			EnergieDBService service = Settings.getDBService();
			DBIterator list = service.createList(ZaehlerWasser.class);
			...
			while (list.hasNext()) {
				ZaehlerWasser zaehler = (ZaehlerWasser) list.next();
			...
			Logger.error("error while updating zaehler", e);
			throw new ApplicationException(Settings.i18n().tr("error while updating zaehler"));
		}
	}
}

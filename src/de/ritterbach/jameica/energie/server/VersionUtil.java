...
public class VersionUtil
{
   ...
   */
  public static Version getVersion(EnergieDBService service, String name) throws RemoteException, ApplicationException
  {
   ...
   * @throws RemoteException
   */
  public static int deleteAll(EnergieDBService service, String prefix) throws RemoteException
  {
   ...
   * @throws RemoteException
   */
  public static int delete(EnergieDBService service, String name) throws RemoteException
  {
    if (name == null || name.length() == 0)

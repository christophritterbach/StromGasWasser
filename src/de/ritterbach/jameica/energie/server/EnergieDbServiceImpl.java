...
public class EnergieDbServiceImpl extends DBServiceImpl implements EnergieDBService {
	private DBSupport driver = null;

	/**
	 * @throws RemoteException
	 */
	public EnergieDbServiceImpl() throws RemoteException {
	...
	public void checkConsistency() throws RemoteException, ApplicationException {
		...
		try {
			...
			UpdateProvider provider = new EnergieUpdateProvider(getConnection(), version);
			...
			// Siehe auch
			// https://www.h2database.com/javadoc/org/h2/api/ErrorCode.html#c90131
			Throwable t = e;
	...
	protected Connection getConnection() throws RemoteException {
		try {
			...
			// Wir benachrichtigen Jameica ueber den Fehler, damit beim Shutdown kein Backup
			// erstellt wird
	...
	/**
	 * @see de.willuhn.jameica.hbci.rmi.HBCIDBService#executeUpdate(java.lang.String,
	 *      java.lang.String[])
	 */
	@Override
	...
	/**
	 * @see de.willuhn.datasource.db.DBServiceImpl#createObject(java.lang.Class,
	 *      java.lang.String)
	 */
	@Override
	...
	/**
	 * @see de.willuhn.datasource.db.DBServiceImpl#execute(java.lang.String,
	 *      java.lang.Object[], de.willuhn.datasource.rmi.ResultSetExtractor)
	 */
	@Override

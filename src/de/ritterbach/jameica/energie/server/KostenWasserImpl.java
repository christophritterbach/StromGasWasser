...
public class KostenWasserImpl extends AbstractDBObject implements KostenWasser {

	public KostenWasserImpl() throws RemoteException {
		super();
	}
	...
	protected boolean checktTimeframe(Date datum) throws RemoteException {
		String sql = "SELECT COUNT(*) FROM kosten_wasser where ? BETWEEN gueltig_von AND gueltig_bis AND id != ?";

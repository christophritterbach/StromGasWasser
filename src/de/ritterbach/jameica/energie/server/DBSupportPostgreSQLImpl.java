...
public class DBSupportPostgreSQLImpl extends AbstractDBSupportImpl
{
  ...
  {
    return EnergieDBService.SETTINGS.getString("database.driver.postgresql.jdbcdriver","org.postgresql.Driver");
  }
  ...
  {
    return EnergieDBService.SETTINGS.getString("database.driver.postgresql.jdbcurl","jdbc:postgresql://localhost:5432/hibiscus");
  }
  ...
  {
    return EnergieDBService.SETTINGS.getString("database.driver.postgresql.username","hibiscus");
  }

...
public class KostenGasImpl extends AbstractDBObject implements KostenGas {

	public KostenGasImpl() throws RemoteException {
		super();
	}
	...
	protected boolean checktTimeframe(Date datum) throws RemoteException {
		String sql = "SELECT COUNT(*) FROM kosten_gas where ? BETWEEN gueltig_von AND gueltig_bis AND id != ?";

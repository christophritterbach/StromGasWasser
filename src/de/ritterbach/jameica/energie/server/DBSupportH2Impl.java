...
public class DBSupportH2Impl extends AbstractDBSupportImpl
{
  ...
  public DBSupportH2Impl()
  {
    ...
    System.setProperty(EnergieDbServiceImpl.class.getName() + ".uppercase","true");
  ...
  {
    String password = EnergieDBService.SETTINGS.getString("database.driver.h2.encryption.encryptedpassword",null);
    try
    {
      ...
      if (password == null)
      {
        ...
        EnergieDBService.SETTINGS.setAttribute("database.driver.h2.encryption.encryptedpassword",Base64.encode(bos.toByteArray()));
  ...
  public String getJdbcUrl()
  {
    ...
    if (EnergieDBService.SETTINGS.getBoolean("database.driver.h2.recover",false))
    {
      Logger.warn("#############################################################");
    ...
    String addon = EnergieDBService.SETTINGS.getString("database.driver.h2.parameters",null);
    if (addon != null)
      url += ";" + addon;

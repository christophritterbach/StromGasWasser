...
public class DBSupportMySqlImpl extends AbstractDBSupportImpl
{
  ...
  {
    return EnergieDBService.SETTINGS.getString("database.driver.mysql.jdbcdriver",DRIVER);
  }
  ...
  {
    return EnergieDBService.SETTINGS.getString("database.driver.mysql.jdbcurl","jdbc:mariadb://localhost:3306/energie?useUnicode=Yes&characterEncoding=ISO8859_1&serverTimezone=Europe/Paris");
  }
  ...
  {
    return EnergieDBService.SETTINGS.getString("database.driver.mysql.username","energie");
  }
